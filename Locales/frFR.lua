...
ArgusEliteTracker.OverrideLanguage[locale] = function()
    ...
    ----http://fr.wowhead.com/npc=124775
    --L["Commander Endaxis"]          = "Commandant Endaxis"
    ----http://fr.wowhead.com/npc=122912
    --L["Commander Sathrenael"]       = "Commandant Sathrenaël"
    ----http://fr.wowhead.com/npc=122911
    --L["Commander Vecaya"]           = "Commandant Vecaya"
    ----http://fr.wowhead.com/npc=125820
    --L["Imp Mother Laglath"]         = "Mère des diablotins Laglath"
    ----http://fr.wowhead.com/npc=125824
    --L["Khazaduum"]                  = "Khazaduum"
    ----http://fr.wowhead.com/npc=126419
    --L["Naroua"]                     = "Naroua"
    ----http://fr.wowhead.com/npc=120393
    --L["Siegemaster Voraan"]         = "Maître de siège Voraan"
    ----http://fr.wowhead.com/npc=123464
    --L["Sister Subversia"]           = "Soeur Subversia"
    ----http://fr.wowhead.com/npc=123689
    --L["Talestra the Vile"]          = "Talestra l'Infâme"
    ----http://fr.wowhead.com/npc=125479
    --L["Tar Spitter"]                = "Crache-goudron"
    ----http://fr.wowhead.com/npc=124804
    --L["Tereck the Selector"]        = "Tereck le Sélectionneur"
    ----http://fr.wowhead.com/npc=125388
    --L["Vagath the Betrayed"]        = "Vagath le Trahi"

    ----http://fr.wowhead.com/npc=127090
    --L["Admiral Rel'var"]            = "Amiral Rel'var"
    ----http://fr.wowhead.com/npc=127096
    --L["All-Seer Xanarian"]          = "Xanarian l'Omnivoyant"
    ----http://fr.wowhead.com/npc=122958
    --L["Blistermaw"]                 = "Gueule putride"
    ----http://fr.wowhead.com/npc=127376
    --L["Chief Alchemist Munculus"]   = "Chef alchimiste Gromuncule"
    ----http://fr.wowhead.com/npc=127084
    --L["Commander Texlaz"]           = "Commandant Texlaz"
    ----http://fr.wowhead.com/npc=127703
    --L["Doomcaster Suprax"]          = "Lance-malheur Suprax"
    ----http://fr.wowhead.com/npc=122999
    --L["Gar'zoth"]                   = "Gar'zoth"
    ----http://fr.wowhead.com/npc=127288
    --L["Houndmaster Kerrax"]         = "Dresseur de molosses Kerrax"
    ----http://fr.wowhead.com/npc=126946
    --L["Inquisitor Vethroz"]         = "Inquisiteur Vethroz"
    ----http://fr.wowhead.com/npc=126254
    --L["Lieutenant Xakaar"]          = "Lieutenant Xakaar"
    ----http://fr.wowhead.com/npc=122947
    --L["Mistress Il'thendra"]        = "Maîtresse Il'thendra"
    ----http://fr.wowhead.com/npc=127705
    --L["Mother Rosula"]              = "Mère Rosula"
    ----http://fr.wowhead.com/npc=126040
    --L["Puscilla"]                   = "Puscilla"
    ----http://fr.wowhead.com/npc=127706
    --L["Rezira the Seer"]            = "Rézira le Voyant"
    ----http://fr.wowhead.com/npc=127700
    --L["Squadron Commander Vishax"]  = "Commandant d'escadron Vishax"
    ----http://fr.wowhead.com/npc=127581
    --L["The Many-Faced Devourer"]    = "Le Dévoreur aux cent visages"
    ----http://fr.wowhead.com/npc=126208
    --L["Varga"]                      = "Varga"
    ----http://fr.wowhead.com/npc=126115
    --L["Ven'orn"]                    = "Ven'orn"
    ----http://fr.wowhead.com/npc=127300
    --L["Void Warden Valsuran"]       = "Gardienne du Vide Valsuran"
    ----http://fr.wowhead.com/npc=126199
    --L["Vrax'thul"]                  = "Vrax'thul"
    ----http://fr.wowhead.com/npc=127291
    --L["Watcher Aival"]              = "Veilleur Aival"
    ----http://fr.wowhead.com/npc=127118
    --L["Worldsplitter Skuul"]        = "Skuul le Pourfendeur"
    ----http://fr.wowhead.com/npc=126338
    --L["Wrath-Lord Yarez"]           = "Seigneur du courroux Yarez"


    ----http://fr.wowhead.com/npc=126887
    --L["Ataxon"]                     = "Ataxon"
    ----http://fr.wowhead.com/npc=126862
    --L["Baruut the Bloodthirsty"]    = "Baruut le Sanguinaire"
    ----http://fr.wowhead.com/npc=126869
    --L["Captain Faruq"]              = "Capitaine Faruq"
    ----http://fr.wowhead.com/npc=126910
    --L["Commander Xethgar"]          = "Commandant Xethgar"
    ----http://fr.wowhead.com/npc=126864
    --L["Feasel the Muffin Thief"]    = "Feasel le voleur de muffins"
    ----http://fr.wowhead.com/npc=126896
    --L["Herald of Chaos"]            = "Héraut du chaos"
    ----http://fr.wowhead.com/npc=126900
    --L["Instructor Tarahna"]         = "Instructrice Tarahna"
    ----http://fr.wowhead.com/npc=126899
    --L["Jed'hin Champion Vorusk"]    = "Champion jed'hin Vorusk"
    ----http://fr.wowhead.com/npc=126860
    --L["Kaara the Pale"]             = "Kaara le Pâle"
    ----http://fr.wowhead.com/npc=124440
    --L["Overseer Y'Beda"]            = "Surveillante Y'Beda"
    ----http://fr.wowhead.com/npc=125498
    --L["Overseer Y'Morna"]           = "Surveillante Y'Morna"
    ----http://fr.wowhead.com/npc=125497
    --L["Overseer Y'Sorna"]           = "Surveillante Y'Sorna"
    ----http://fr.wowhead.com/npc=126898
    --L["Sabuul"]                     = "Sabuul"
    ----http://fr.wowhead.com/npc=122838
    --L["Shadowcaster Voruun"]        = "Exhalombre Voruun"
    ----http://fr.wowhead.com/npc=126912
    --L["Skreeg the Devourer"]        = "Skreeg le Dévoreur"
    ----http://fr.wowhead.com/npc=126913
    --L["Slithon the Last"]           = "Ondulon le Dernier"
    ----http://fr.wowhead.com/npc=126889
    --L["Sorolis the Ill-Fated"]      = "Sorolis l'Infortuné"
    ----http://fr.wowhead.com/npc=126815
    --L["Soultwisted Monstrosity"]    = "Monstruosité à l'âme distordue"
    ----http://fr.wowhead.com/npc=126868
    --L["Turek the Lucid"]            = "Turek le Lucide"
    ----http://fr.wowhead.com/npc=126885
    --L["Umbraliss"]                  = "Umbraliss"
    ----http://fr.wowhead.com/npc=126867
    --L["Venomtail Skyfin"]           = "Ciaileron queue-venin"
    ----http://fr.wowhead.com/npc=126866
    --L["Vigilant Kuro"]              = "Vigilant Kuro"
    ----http://fr.wowhead.com/npc=126865
    --L["Vigilant Thanos"]            = "Vigilant Thanos"
    ----http://fr.wowhead.com/npc=126852
    --L["Wrangler Kravos"]            = "Kravos le Dompteur"
    ----http://fr.wowhead.com/npc=126908
    --L["Zul'tan the Numerous"]       = "Zul'tan l'Abondant"
...
-- ArgusEliteTracker.RegisteredSearchTerms[locale] = L["French"]
