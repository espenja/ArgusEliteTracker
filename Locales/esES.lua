...
ArgusEliteTracker.OverrideLanguage[locale] = function()
    ...
    ----http://es.wowhead.com/npc=124775
    --L["Commander Endaxis"]          = "Comandante Endaxis"
    ----http://es.wowhead.com/npc=122912
    --L["Commander Sathrenael"]       = "Comandante Sathrenael"
    ----http://es.wowhead.com/npc=122911
    --L["Commander Vecaya"]           = "Comandante Vecaya"
    ----http://es.wowhead.com/npc=125820
    --L["Imp Mother Laglath"]         = "Madre de diablillos Laglath"
    ----http://es.wowhead.com/npc=125824
    --L["Khazaduum"]                  = "Khazaduum"
    ----http://es.wowhead.com/npc=126419
    --L["Naroua"]                     = "Naroua"
    ----http://es.wowhead.com/npc=120393
    --L["Siegemaster Voraan"]         = "Maestro de asedio Voraan"
    ----http://es.wowhead.com/npc=123464
    --L["Sister Subversia"]           = "Hermana Subversia"
    ----http://es.wowhead.com/npc=123689
    --L["Talestra the Vile"]          = "Talestra la Vil"
    ----http://es.wowhead.com/npc=125479
    --L["Tar Spitter"]                = "Escupebrea"
    ----http://es.wowhead.com/npc=124804
    --L["Tereck the Selector"]        = "Tereck el Selector"
    ----http://es.wowhead.com/npc=125388
    --L["Vagath the Betrayed"]        = "Vagath el Traicionado"

    --http://es.wowhead.com/npc=127090
    --L["Admiral Rel'var"]            = "Almirante Rel'var"
    --http://es.wowhead.com/npc=127096
    --L["All-Seer Xanarian"]          = "Omnividente Xanarian"
    --http://es.wowhead.com/npc=122958
    --L["Blistermaw"]                 = "Faucellaga"
    --http://es.wowhead.com/npc=127376
    --L["Chief Alchemist Munculus"]   = "Alquimista jefe Munculus"
    --http://es.wowhead.com/npc=127084
    --L["Commander Texlaz"]           = "Comandante Texlaz"
    --http://es.wowhead.com/npc=127703
    --L["Doomcaster Suprax"]          = "Taumaturgo de fatalidad Suprax"
    --http://es.wowhead.com/npc=122999
    --L["Gar'zoth"]                   = "Gar'zoth"
    --http://es.wowhead.com/npc=127288
    --L["Houndmaster Kerrax"]         = "Maestro de canes Kerrax"
    --http://es.wowhead.com/npc=126946
    --L["Inquisitor Vethroz"]         = "Inquisidor Vethroz"
    --http://es.wowhead.com/npc=126254
    --L["Lieutenant Xakaar"]          = "Teniente Xakaar"
    --http://es.wowhead.com/npc=122947
    --L["Mistress Il'thendra"]        = "Maestra Il'thendra"
    --http://es.wowhead.com/npc=127705
    --L["Mother Rosula"]              = "Madre Rosula"
    --http://es.wowhead.com/npc=126040
    --L["Puscilla"]                   = "Puscilla"
    --http://es.wowhead.com/npc=127706
    --L["Rezira the Seer"]            = "Rezira el Vidente"
    --http://es.wowhead.com/npc=127700
    --L["Squadron Commander Vishax"]  = "Comandante de escuadrón Vishax"
    --http://es.wowhead.com/npc=127581
    --L["The Many-Faced Devourer"]    = "El Devorador de Mil Caras"
    --http://es.wowhead.com/npc=126208
    --L["Varga"]                      = "Varga"
    --http://es.wowhead.com/npc=126115
    --L["Ven'orn"]                    = "Ven'orn"
    --http://es.wowhead.com/npc=127300
    --L["Void Warden Valsuran"]       = "Celadora del Vacío Valsuran"
    --http://es.wowhead.com/npc=126199
    --L["Vrax'thul"]                  = "Vrax'thul"
    --http://es.wowhead.com/npc=127291
    --L["Watcher Aival"]              = "Vigía Aival"
    --http://es.wowhead.com/npc=127118
    --L["Worldsplitter Skuul"]        = "Quiebramundos Skuul"
    --http://es.wowhead.com/npc=126338
    --L["Wrath-Lord Yarez"]           = "Señor de la cólera Yarez"


    --http://es.wowhead.com/npc=126887
    --L["Ataxon"]                     = "Ataxon"
    --http://es.wowhead.com/npc=126862
    --L["Baruut the Bloodthirsty"]    = "Baruut el Sanguinario"
    --http://es.wowhead.com/npc=126869
    --L["Captain Faruq"]              = "Capitán Faruq"
    --http://es.wowhead.com/npc=126910
    --L["Commander Xethgar"]          = "Comandante Xethgar"
    --http://es.wowhead.com/npc=126864
    --L["Feasel the Muffin Thief"]    = "Feasel, el Ladrón de Magdalenas"
    --http://es.wowhead.com/npc=126896
    --L["Herald of Chaos"]            = "Heraldo del caos"
    --http://es.wowhead.com/npc=126900
    --L["Instructor Tarahna"]         = "Instructora Tarahna"
    --http://es.wowhead.com/npc=126899
    --L["Jed'hin Champion Vorusk"]    = "Campeón jed'hin Vorusk"
    --http://es.wowhead.com/npc=126860
    --L["Kaara the Pale"]             = "Kaara la Pálida"
    --http://es.wowhead.com/npc=124440
    --L["Overseer Y'Beda"]            = "Sobrestante Y'Beda"
    --http://es.wowhead.com/npc=125498
    --L["Overseer Y'Morna"]           = "Sobrestante Y'Morna"
    --http://es.wowhead.com/npc=125497
    --L["Overseer Y'Sorna"]           = "Sobrestante Y'Sorna"
    --http://es.wowhead.com/npc=126898
    --L["Sabuul"]                     = "Sabuul"
    --http://es.wowhead.com/npc=122838
    --L["Shadowcaster Voruun"]        = "Taumaturgo umbrío Voruun"
    --http://es.wowhead.com/npc=126912
    --L["Skreeg the Devourer"]        = "Skreeg el Devorador"
    --http://es.wowhead.com/npc=126913
    --L["Slithon the Last"]           = "Slithon el Último"
    --http://es.wowhead.com/npc=126889
    --L["Sorolis the Ill-Fated"]      = "Sorolis el Desventurado"
    --http://es.wowhead.com/npc=126815
    --L["Soultwisted Monstrosity"]    = "Monstruosidad de espíritu retorcido"
    --http://es.wowhead.com/npc=126868
    --L["Turek the Lucid"]            = "Turek el Lúcido"
    --http://es.wowhead.com/npc=126885
    --L["Umbraliss"]                  = "Umbraliss"
    --http://es.wowhead.com/npc=126867
    --L["Venomtail Skyfin"]           = "Aletacielo Colaveneno"
    --http://es.wowhead.com/npc=126866
    --L["Vigilant Kuro"]              = "Vigilante Kuro"
    --http://es.wowhead.com/npc=126865
    --L["Vigilant Thanos"]            = "Vigilante Thanos"
    --http://es.wowhead.com/npc=126852
    --L["Wrangler Kravos"]            = "Retador Kravos"
    --http://es.wowhead.com/npc=126908
    --L["Zul'tan the Numerous"]       = "Zul'tan el Cuantioso"
...
-- ArgusEliteTracker.RegisteredSearchTerms[locale] = L["Spanish (Spain)"]
