...
ArgusEliteTracker.OverrideLanguage[locale] = function()
    ...
    ----http://it.wowhead.com/npc=124775
    --L["Commander Endaxis"]          = "Comandante Endaxis"
    ----http://it.wowhead.com/npc=122912
    --L["Commander Sathrenael"]       = "Comandante Sathrenael"
    ----http://it.wowhead.com/npc=122911
    --L["Commander Vecaya"]           = "Comandante Vecaya"
    ----http://it.wowhead.com/npc=125820
    --L["Imp Mother Laglath"]         = "Madre degli Imp Laglath"
    ----http://it.wowhead.com/npc=125824
    --L["Khazaduum"]                  = "Khazaduum"
    ----http://it.wowhead.com/npc=126419
    --L["Naroua"]                     = "Naroua"
    ----http://it.wowhead.com/npc=120393
    --L["Siegemaster Voraan"]         = "Maestro d'Assedio Voraan"
    ----http://it.wowhead.com/npc=123464
    --L["Sister Subversia"]           = "Sorella Subversia"
    ----http://it.wowhead.com/npc=123689
    --L["Talestra the Vile"]          = "Talestra la Vile"
    ----http://it.wowhead.com/npc=125479
    --L["Tar Spitter"]                = "Sputapece"
    ----http://it.wowhead.com/npc=124804
    --L["Tereck the Selector"]        = "Tereck il Selettore"
    ----http://it.wowhead.com/npc=125388
    --L["Vagath the Betrayed"]        = "Vagath il Tradito"

    --http://it.wowhead.com/npc=127090
    --L["Admiral Rel'var"]            = "Ammiraglio Rel'var"
    --http://it.wowhead.com/npc=127096
    --L["All-Seer Xanarian"]          = "Xanarian l'Onnisciente"
    --http://it.wowhead.com/npc=122958
    --L["Blistermaw"]                 = "Faucimarce"
    --http://it.wowhead.com/npc=127376
    --L["Chief Alchemist Munculus"]   = "Capo Alchimista Munculus"
    --http://it.wowhead.com/npc=127084
    --L["Commander Texlaz"]           = "Comandante Texlaz"
    --http://it.wowhead.com/npc=127703
    --L["Doomcaster Suprax"]          = "Scagliarovina Suprax"
    --http://it.wowhead.com/npc=122999
    --L["Gar'zoth"]                   = "Gar'zoth"
    --http://it.wowhead.com/npc=127288
    --L["Houndmaster Kerrax"]         = "Maestro dei Segugi Kerrax"
    --http://it.wowhead.com/npc=126946
    --L["Inquisitor Vethroz"]         = "Inquisitore Vethroz"
    --http://it.wowhead.com/npc=126254
    --L["Lieutenant Xakaar"]          = "Luogotenente Xakaar"
    --http://it.wowhead.com/npc=122947
    --L["Mistress Il'thendra"]        = "Dama Il'thendra"
    --http://it.wowhead.com/npc=127705
    --L["Mother Rosula"]              = "Madre Rosula"
    --http://it.wowhead.com/npc=126040
    --L["Puscilla"]                   = "Puscilla"
    --http://it.wowhead.com/npc=127706
    --L["Rezira the Seer"]            = "Rezira il Veggente"
    --http://it.wowhead.com/npc=127700
    --L["Squadron Commander Vishax"]  = "Comandante di Squadrone Vishax"
    --http://it.wowhead.com/npc=127581
    --L["The Many-Faced Devourer"]    = "Divoratore dai Mille Volti"
    --http://it.wowhead.com/npc=126208
    --L["Varga"]                      = "Varga"
    --http://it.wowhead.com/npc=126115
    --L["Ven'orn"]                    = "Ven'orn"
    --http://it.wowhead.com/npc=127300
    --L["Void Warden Valsuran"]       = "Guardiana del Vuoto Valsuran"
    --http://it.wowhead.com/npc=126199
    --L["Vrax'thul"]                  = "Vrax'thul"
    --http://it.wowhead.com/npc=127291
    --L["Watcher Aival"]              = "Guardiano Aival"
    --http://it.wowhead.com/npc=127118
    --L["Worldsplitter Skuul"]        = "Spezzamondi Skuul"
    --http://it.wowhead.com/npc=126338
    --L["Wrath-Lord Yarez"]           = "Signore dell'Ira Yarez"


    --http://it.wowhead.com/npc=126887
    --L["Ataxon"]                     = "Ataxon"
    --http://it.wowhead.com/npc=126862
    --L["Baruut the Bloodthirsty"]    = "Baruut il Sanguinario"
    --http://it.wowhead.com/npc=126869
    --L["Captain Faruq"]              = "Capitano Faruq"
    --http://it.wowhead.com/npc=126910
    --L["Commander Xethgar"]          = "Comandante Xethgar"
    --http://it.wowhead.com/npc=126864
    --L["Feasel the Muffin Thief"]    = "Feasel il Ladro di Muffin"
    --http://it.wowhead.com/npc=126896
    --L["Herald of Chaos"]            = "Araldo del Caos"
    --http://it.wowhead.com/npc=126900
    --L["Instructor Tarahna"]         = "Istruttrice Tarahna"
    --http://it.wowhead.com/npc=126899
    --L["Jed'hin Champion Vorusk"]    = "Campione del Jed'hin Vorusk"
    --http://it.wowhead.com/npc=126860
    --L["Kaara the Pale"]             = "Kaara la Pallida"
    --http://it.wowhead.com/npc=124440
    --L["Overseer Y'Beda"]            = "Sovrintendente Y'beda"
    --http://it.wowhead.com/npc=125498
    --L["Overseer Y'Morna"]           = "Sovrintendente Y'morna"
    --http://it.wowhead.com/npc=125497
    --L["Overseer Y'Sorna"]           = "Sovrintendente Y'sorna"
    --http://it.wowhead.com/npc=126898
    --L["Sabuul"]                     = "Sabuul"
    --http://it.wowhead.com/npc=122838
    --L["Shadowcaster Voruun"]        = "Mago d'Ombra Voruun"
    --http://it.wowhead.com/npc=126912
    --L["Skreeg the Devourer"]        = "Skreeg il Divoratore"
    --http://it.wowhead.com/npc=126913
    --L["Slithon the Last"]           = "Slithon l'Estremo"
    --http://it.wowhead.com/npc=126889
    --L["Sorolis the Ill-Fated"]      = "Sorolis lo Sfortunato"
    --http://it.wowhead.com/npc=126815
    --L["Soultwisted Monstrosity"]    = "Mostruosità dall'Anima Corrotta"
    --http://it.wowhead.com/npc=126868
    --L["Turek the Lucid"]            = "Turek il Lucido"
    --http://it.wowhead.com/npc=126885
    --L["Umbraliss"]                  = "Umbraliss"
    --http://it.wowhead.com/npc=126867
    --L["Venomtail Skyfin"]           = "Pinnaceleste Codavenefica"
    --http://it.wowhead.com/npc=126866
    --L["Vigilant Kuro"]              = "Vigilante Kuro"
    --http://it.wowhead.com/npc=126865
    --L["Vigilant Thanos"]            = "Vigilante Thanos"
    --http://it.wowhead.com/npc=126852
    --L["Wrangler Kravos"]            = "Mandriano Kravos"
    --http://it.wowhead.com/npc=126908
    --L["Zul'tan the Numerous"]       = "Zul'tan il Molteplice"
...
-- ArgusEliteTracker.RegisteredSearchTerms[locale] = L["Italian"]
